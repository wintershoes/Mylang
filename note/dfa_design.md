...
1.testScan，会测试语法规则是否正确读入
2.testMatch，会提供一连串的字符串，识别是否为标识符或者数字
3.testLexer，会测试对输入文件的词法分析结果，打印错误信息

将grammar和input文件放入input文件夹里，直接运行run.bat可以测试结果：

若输入为：![image-20240327144352187](img/image-20240327144352187.png)

用testLexer测试，结果为：

![image-20240327144417067](img/image-20240327144417067.png)
